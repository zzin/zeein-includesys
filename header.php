...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header fixed top-0 w-full z-10">
		<div class="container mx-auto px-6 md:px-8 relative h-100px">
			...
			<div class="toggle-dark absolute top-1/2 -translate-y-1/2 right-20 opacity-0 transition-opacity z-10 select-none">
				<label for="toggleTheme" class="flex items-center cursor-pointer">
					<div class="relative">
						<input type="checkbox" id="toggleTheme" class="sr-only">
						<div class="block bg-black bg-opacity-5 w-14 h-8 rounded-full dark:bg-white dark:bg-opacity-10"></div>
						<!-- icon : day -->
						...
						<div class="dot absolute left-1 top-1 bg-gray-800 w-6 h-6 rounded-full dark:bg-gray-200"></div>
					</div>
				</label>
			</div>
			<nav id="site-navigation" class="main-navigation">
				<button class="menu-toggle h-8 w-8 appearnace-none border-0 block absolute right-8 top-1/2 -translate-y-1/2 z-20" aria-controls="primary-menu" aria-expanded="false">
